  ...
  const trainingServices = [
    {
      ...
      details:
        "Comprehensive laboratory training programs covering modern techniques, equipment handling, and quality control procedures following international standards.",
    },
    {
      icon: GraduationCap,
      ...
      details:
        "Advanced training programs for undergraduate and postgraduate students in life sciences, biotechnology, and related fields.",
    },
    {
      icon: Heart,
      name: "DMLT Training",
      ...
      details:
        "Professional certification training for Medical Laboratory Technology with practical experience and industry-relevant skills.",
    },
    {
      icon: Users,
      ...
      details:
        "Complete nursing education programs covering patient care, medical procedures, and healthcare management skills.",
    },
    {
      icon: BookOpen,
      ...
      details:
        "Comprehensive support for research projects, thesis writing, and dissertation completion for undergraduate and postgraduate students.",
    },
    {
      icon: Award,
      ...
      details:
        "Job placement assistance, career counseling, and industry connections to help students secure positions in healthcare and research sectors.",
    },
  ];
        ...
        <div className="w-[90vw] mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-green-100 leading-relaxed">
              ...
              professionals with comprehensive skill development and career
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Practical experience with modern equipment and techniques",
              },
              {
                title: "Industry Standards",
                description:
                  "Training programs aligned with national and international norms",
              },
              {
            ...
            {[
              {
                ...
                duration: "3-6 months",
                description:
                  "Short-term certification courses for specific skills and techniques",
                features: [
              ...
              },
              {
                ...
                duration: "1-2 years",
                description:
                  "Comprehensive diploma courses with extensive practical training",
                features: [
      ...
      <section className="py-20 bg-gray-50">
        <div className="w-[90vw] mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our training programs have helped hundreds of students achieve
              their career goals
            </p>
          </motion.div>
        ...
        <div className="w-[90vw] mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-green-100 mb-8">
              Join our training programs and get the skills and support you need
              to succeed in the healthcare and research industry.
            </p>
