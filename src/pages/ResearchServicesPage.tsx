  ...
  const researchServices = [
    {
      ...
      details:
        "Professional field survey services for research projects, market studies, and data collection with trained surveyors and standardized methodologies.",
    },
    {
      icon: BarChart3,
      ...
      details:
        "Systematic data collection services using modern tools and techniques, ensuring accuracy and reliability for research and analytical purposes.",
    },
    {
      icon: FlaskConical,
      ...
      details:
        "Professional collection of biological specimens, environmental samples, and research materials following international standards and protocols.",
    },
    {
      icon: Users,
      ...
      details:
        "Community engagement and survey programs for public health research, social studies, and community development initiatives.",
    },
    {
      icon: Heart,
      ...
      details:
        "Educational programs and awareness campaigns for health promotion, disease prevention, and community health improvement.",
    },
  ];
        ...
        <div className="w-[90vw] mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              methodologies and experienced professionals
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Research conducted following international scientific standards",
              },
              {
                title: "Experienced Team",
                description:
                  "Qualified researchers with extensive field experience",
              },
              {
                title: "Modern Equipment",
                description:
                  "State-of-the-art tools and technology for data collection",
              },
              {
            ...
            {[
              {
                ...
                description:
                  "Community health studies, epidemiological surveys, and health behavior research",
              },
              {
                title: "Clinical Research",
                description:
                  "Clinical trials support, patient data collection, and medical research assistance",
              },
              {
                title: "Environmental Studies",
                description:
                  "Environmental impact assessments, pollution monitoring, and ecological research",
              },
              {
                title: "Social Research",
                description:
                  "Social behavior studies, demographic surveys, and community development research",
              },
              {
                title: "Market Research",
                description:
                  "Consumer behavior studies, market analysis, and business research support",
              },
              {
                title: "Academic Research",
                description:
                  "Thesis and dissertation support, literature reviews, and academic project assistance",
              },
            ].map((area, index) => (
              <motion.div
                key={area.title}
        ...
        <div className="w-[90vw] mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-green-100 mb-8">
              Partner with us for your research projects. Our experienced team
              provides comprehensive research support with scientific rigor and
